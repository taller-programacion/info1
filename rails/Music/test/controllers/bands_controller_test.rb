...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { description: @band.description, genre: @band.genre, name: @band.name, year: @band.year } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { description: @band.description, genre: @band.genre, name: @band.name, year: @band.year } }
